...
document.addEventListener('keydown', () => {
  ...
  function displayVictoryMess(moves) {
    document.getElementById("moves").innerHTML = "Te moviste " + moves + " veces.";
  ...
  // Establecemos el color de las líneas a celeste neón
  ctx.strokeStyle = '#39FF14'; // Color celeste neón
